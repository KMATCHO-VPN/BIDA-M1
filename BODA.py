...
`MMMMMMMb.   6MMMMb  `MMMMMMMb.     dM.     
 MM    `Mb  8P    Y8  MM    `Mb    ,MMb     
 MM     MM 6M      Mb MM     MM    d'YM.    
 MM    .M9 MM      MM MM     MM   ,P `Mb    
 MMMMMMM(  MM      MM MM     MM   d'  YM.   
 MM    `Mb MM      MM MM     MM  ,P   `Mb   
 MM     MM MM      MM MM     MM  d'    YM.  
 MM     MM YM      M9 MM     MM ,MMMMMMMMb  
 MM    .M9  8b    d8  MM    .M9 d'      YM. 
_MMMMMMM9'   YMMMM9  _MMMMMMM9_dM_     _dMM_                                 
{A}──────────────────────────────────────────────────
{G1}[{A}={G1}]{G1} OWNER    {A}:{G1} KMATCHO LOUHICHI
{G1}[{A}={G2}]{G2} FACEBOOK {A}:{G2} KMATCHO AL-LHONTKOR
{G1}[{A}={G3}]{G3} TOOLTYPE {A}:{G3} FILE {A}&{G4}
{G1}[{A}={G4}]{G4} VERSION  {A}:{G4} 1.0
